    ...
    build: {
      rollupOptions: {
        input: {
          ...
          // Hero A/B/C variants — generated by scripts/build-variants.mjs from
          // index.html. Edge middleware (middleware.js) rewrites `/` to one of
          // these three paths based on a sticky cookie. Variants are noindex'd.
          "variant-a": resolve(__dirname, "_variants/a/index.html"),
          "variant-b": resolve(__dirname, "_variants/b/index.html"),
          "variant-c": resolve(__dirname, "_variants/c/index.html"),
          ...guideHtmlInputs(),
        },
      },
    },
